...
<div class="container col-md-11 mt-4 mb-4">
	...
	<div class="container col-md-11 d-flex">
		<div>
			<div class="container col-md-11 bg-white pt-3 ">
				<h3 class="container col-md-7 mt-3 pt-1 pb-1 display-5 text-info rounded text-center text-uppercase">Blog sur la culture Marocaine</h3>
				<h6 class="container col-md-7 mt-2  text-center text-dark"> Al Maghrib, signifiant le “couchant” ou l’Occident. </h6>
				<p class="container col-md-10 mt-4 mb-5 text-justify ">Porte de l’Afrique pour les Européens. Dépaysement assuré à quelques heures de Paris. Fès et sa magnifique médina. Marrakech et sa célèbre place Jamaa el Fna. Le sud marocain avec ses nombreuses kasbah et ses portes vers le désert du Sahara. Et tout le reste. Voyager au Maroc c’est aussi découvrir une cuisine variée: tajines, couscous, pâtisseries marocaines, thé à la menthe, …</p>
			</div>
