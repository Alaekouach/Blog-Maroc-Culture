<?php
	 ...
	 $requette2=$bdd->prepare('SELECT * FROM articles,utilisateurs,categorie WHERE articles.id_user=utilisateurs.id_user AND articles.id_categorie=categorie.id_categorie order by articles.date_creation');
...
<main>
	...
	<div class="container col-md-11 mt-4 mb-3">
	...
	<div class="container col-md-11 d-flex pt-3">
		...
		<div class="">
			<div class="container col-md-11 pt-3 ml-4 ssearch-desk">
				<h5 class="col-md-10  ml-5 mb-4 "> Les résultats de votre recherche sur : <span class="text-primary">"<?php echo $var ?>"</span></h5>
            </div>

			<div class="container col-md-11 pt-3 ssearch-mob">
				<h6 class="col-md-12 mb-3"> Les résultats de votre recherche sur : <span class="text-primary">"<?php echo $var ?>"</span></h6>
            </div>

			<div class=" container d-flex flex-wrap col-md-11 ">
				<?php  while($affiche_search=$requette4->fetch() ) {   ?>
					<div class="container col-md-5 mb-4 pt-2 bg-white">
						<div class="">
							<a href="affiche_article.php?id_article=<?php echo $affiche_search['id_article'] ?>"><img src="<?php echo $affiche_search['img_article'] ?>" alt="" class="mb-2" style="width:100%"></a>
						</div>
						<a href="affiche_article.php?id_article=<?php echo $affiche_search['id_article'] ?>"><small ><strong ><?php echo $affiche_search['titre'] ?></strong></small></a>
						<p class="mt-3"><?php echo $affiche_search['description_article'] ?>...</p>
						<div class="">
							<small><?php echo $affiche_search['date_creation'] ?></small>
							<a href="affiche_article.php?id_article=<?php echo $affiche_search['id_article'] ?>" class="float-right">Lire la suite...</a>
						</div>
