...
try {
	 ...
	 $requette2=$bdd->prepare('SELECT * FROM articles,utilisateurs,categorie WHERE articles.id_user=utilisateurs.id_user AND articles.id_categorie=categorie.id_categorie AND categorie.id_categorie=3');
...
<head>
    ...
    <title>Catégorie Gastronomie</title>
...
<main>
    ...
    <div class="col-md-11 mt-4 ">
				<!-- <h3 class="container col-md-7 mt-3 pt-1 pb-1 display-5 text-info rounded text-center text-uppercase">Gastronomie marocaine est un vrai délices</h3> -->
    </div>
    
	<div class="container col-md-11 d-flex">

	<div class="cat">   
			<h4 class="col-md-5"><small class="titcat"> Catégorie > Gastronomie </small></h4>
