...
try {
	 ...
	 $requette2=$bdd->prepare('SELECT * FROM articles,utilisateurs,categorie WHERE articles.id_user=utilisateurs.id_user AND articles.id_categorie=categorie.id_categorie AND categorie.id_categorie=6');
...
<head>
    ...
    <title>Catégorie Personnalités</title>
...
<main>
    ...
    <div class="col-md-11 mt-4">
				<!-- <h3 class="container col-md-7 mt-3 pt-1 pb-1 display-5 text-info rounded text-center text-uppercase">les personnalités qui ont fait la fierté du Maroc</h3> -->
    </div>
    
	<div class="container col-md-11 d-flex">

		<div class="cat">   
			<h4 class="col-md-5"><small class="titcat"> Catégorie > Personnalités </small></h4>
		...
		<div class="container col-md-3 text-center mt-3 bg-white aaside">
			...
			<div class="container d-flex flex-wrap justify-content-between col-md-9 mt-4 " >
				...
				<div class="mr-4 mt-2">
					<a href="gastronomie"><div><i class="fa fa-cutlery couleur1" aria-hidden="true"></i></div>
