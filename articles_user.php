        ...
        <tbody>
            <?php  while($affiche=$requete_select->fetch()) {   ?>
                <tr>
                        ...
                        <td><button class="border bg-warning"><a href="modification_article_users.php?id_article=<?php echo $affiche['id_article'] ?>" class='text-dark'>Modifier</a></button></td>
                        <td ><button class="border bg-danger "><a href="articles_user.php?id_article=<?php echo $affiche['id_article'] ?>" class=' text-white'>Supprimer</a></button></td>
                </tr>
            <?php  } ?>    
        </tbody>       
    </table>
