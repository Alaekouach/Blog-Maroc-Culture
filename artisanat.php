...
try {
	 ...
	 $requette2=$bdd->prepare('SELECT * FROM articles,utilisateurs,categorie WHERE articles.id_user=utilisateurs.id_user AND articles.id_categorie=categorie.id_categorie AND categorie.id_categorie=4');
...
<head>
    ...
    <title>Catégorie Artisanat</title>
...
<main>
	...
	<div class="container col-md-11 d-flex">
        ...
        <div class="cat">   
			<h4 class="col-md-5"><small class="titcat"> Catégorie > Artisanat </small></h4>
