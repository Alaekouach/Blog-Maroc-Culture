...
<div class="profile-mob">
	...
	<div class="cat-modif-mob pt-3">
        <h5 class="text-white mb-4">Modificaion de la Catégorie</h5>
		
        <form action="" method="POST">
            <div class="container  mb-3 ">
                <input type="text" name="intitule_categorie" class="form-control" value="<?php  echo $affiche_categorie['intitule_categorie'] ?>">
            </div>
			<div class="col-mod-10 d-flex justify-content-between mt-2 mb-3 mr-4">
				<div></div>
				<div>
					<button name="modifier" class="btn btn-sm border bg-warning">Modifier</button>
					<button name="fermer" class="btn btn-sm border bg-light">Fermer</button>
				</div>
			</div>
        </form>
    </div>
...
<div class="container-fluid p-0 mt-5 text-uppercase">
	...
	<div class="cat-modif pt-3">
        <h4 class="text-white mb-5">Modificaion de la Catégorie</h4>
		
        <form action="" method="POST">
            <div class="container input-group mb-4 ml-5 pl-2 col-md-10 ">
                <input type="text" name="intitule_categorie" class="form-control" value="<?php  echo $affiche_categorie['intitule_categorie'] ?>">
            </div>
			<div class="col-mod-10 d-flex justify-content-between mt-2 mb-3 mr-4">
				<div></div>
				<div>
					...
					<button name="fermer" class="btn border bg-light">Fermer</button>
				</div>
			</div>
        </form>
    </div>
