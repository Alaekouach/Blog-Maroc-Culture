...
// selectionner la table article avec l'id de l'utilisateur pour afficher ses articles
	 ...
	 $requete_select11= $bdd->prepare("SELECT * FROM categorie,articles WHERE id_user = ? AND articles.id_categorie=categorie.id_categorie ");
     $requete_select11->execute(array($_SESSION['id_user']));
...
$requete_select22= $bdd->prepare("SELECT * FROM utilisateurs,categorie,articles WHERE  articles.id_categorie=categorie.id_categorie AND articles.id_user=utilisateurs.id_user ");
$requete_select22->execute(array());
// ajout d'un article
...
<div class="profile-mob">
				...
				<tbody>
					<?php  while($affiche=$requete_select->fetch()) {   ?>
						<tr>
							...
							<td><button  class="border bg-light" ><a href="affiche_article.php?id_article=<?php echo $affiche['id_article'] ?>" class='text-dark'><i class="fa fa-book" aria-hidden="true"></i></a></button></td>
							<td class="d-flex">
    ...
    <div class="container col-md-11  mt-5 mb-4" > 		
		<h5 class="ml-3"><u><b>Tous les articles :</b></u></h5> 				
	</div>  
				...
				<tbody>
					<?php  while($affiche=$requete_select2->fetch()) {   ?>
						<tr>
							...
							<td><?php  echo $affiche['titre'] ?></td>
							<td class="d-flex">
								<button  class="border bg-light" ><a href="affiche_article.php?id_article=<?php echo $affiche['id_article'] ?>" class='text-dark'><i class="fa fa-book" aria-hidden="true"></i></a></button>
								<button class="border bg-warning"><a href="modification_article_users.php?id_article=<?php echo $affiche['id_article'] ?>" class='text-dark'><i class="fas fa-pencil-alt"></i></a></button>
								<button class="border bg-danger "><a href="articles_user.php?id_article=<?php echo $affiche['id_article'] ?>" class=' text-white'><i class="fas fa-trash-alt"></i></a></button>
							</td>
						</tr>
...
<div class=" col-md-12 mb-5 bg-light"></div>
    ...
    <div class="container text-uppercase">
      <h3 class="m-5"><b><u> Mes articles :</u></b></h3>
      <table class="table table-bordered text-center">
        <thead class="thead-light">
            <tr>
                <th>Titre</th>
        ...
        <tbody>
            <?php  while($affiche11=$requete_select11->fetch()) {   ?>
                <tr>
                        <td><?php  echo $affiche11['titre'] ?></td>
                        <td><?php  echo $affiche11['date_creation'] ?></td>
                        <td><?php  echo $affiche11['intitule_categorie'] ?></td>
                        <td><?php  echo $affiche11['description_article'] ?></td>
                        <td><button  class="border bg-light" ><a href="affiche_article.php?id_article=<?php echo $affiche11['id_article'] ?>" class='text-dark'>Lire l'article</a></button></td>
                        <td><button class="border bg-warning"><a href="modification_article_admin.php?id_article=<?php echo $affiche11['id_article'] ?>" class='text-dark'>Modifier</a></button></td>
                        <td ><button class="border bg-danger "><a href="articles_admin.php?id_article=<?php echo $affiche11['id_article'] ?>" class=' text-white'>Supprimer</a></button></td>
                </tr>
            <?php  } ?>    
        </tbody>       
    </table>
    ...
    <div class="container text-uppercase">
      <h3 class="m-5"><b><u> Tous les articles :</u></b></h3>
      <table class="table table-bordered text-center">
        <thead class="thead-light">
            <tr>
                <th>username</th>
        ...
        <tbody>
            <?php  while($affiche22=$requete_select22->fetch()) {   ?>
                <tr>
                        <td><?php  echo $affiche22['username'] ?></td>
                        <td><?php  echo $affiche22['titre'] ?></td>
                        <td><?php  echo $affiche22['date_creation'] ?></td>
                        <td><?php  echo $affiche22['intitule_categorie'] ?></td>
                        <td><?php  echo $affiche22['description_article'] ?></td>
                        <td><button  class="border bg-light" ><a href="affiche_article.php?id_article=<?php echo $affiche22['id_article'] ?>" class='text-dark'>Lire l'article</a></button></td>
                        <td><button class="border bg-warning"><a href="modification_article_admin.php?id_article=<?php echo $affiche22['id_article'] ?>" class='text-dark'>Modifier</a></button></td>
                        <td ><button class="border bg-danger "><a href="articles_admin.php?id_article=<?php echo $affiche22['id_article'] ?>" class=' text-white'>Supprimer</a></button></td>
                </tr>
            <?php  } ?>    
        </tbody>       
    </table>
        ...
        <div class="container text-uppercase">
			...
			<h3 class="m-5"><b><u> Ajouter un article :</u></b></h3>
